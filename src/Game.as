package{
	...
	import com.nitrome.phys.HashMap;
	...
	public class Game extends Sprite{
		...
		public static const HASH_MAP_SCALE:Number = 120;
		...
		public function Game(){
			...
			addChild(clicker);
			sim = new Simulation(new Rectangle(0, 0, WIDTH, HEIGHT), HASH_MAP_SCALE);
...
//			if(lastCollider) lastCollider.vx += 0.001;
		...
		private function mouseDown(e:MouseEvent):void{
			...
			var collider:Collider = sim.hashMap.getColliderAt(mouseX, mouseY);
			if(collider){
